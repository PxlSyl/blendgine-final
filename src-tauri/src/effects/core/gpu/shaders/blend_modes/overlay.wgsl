...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    if (overlay.a >= 0.9999) {
        ...
        textureStore(output_texture, vec2<u32>(pos), vec4<f32>(overlay_r, overlay_g, overlay_b, overlay.a));
        return;
    }
    ...
    let overlay_r_premult = overlay_r * overlay.a;
    let overlay_g_premult = overlay_g * overlay.a;
    let overlay_b_premult = overlay_b * overlay.a;
