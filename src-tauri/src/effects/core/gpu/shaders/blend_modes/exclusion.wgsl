...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    if (overlay.a >= 0.9999) {
        ...
        textureStore(output_texture, vec2<u32>(pos), vec4<f32>(exclusion_r, exclusion_g, exclusion_b, overlay.a));
        return;
    }
    ...
    let exclusion_r_premult = exclusion_r * overlay.a;
    let exclusion_g_premult = exclusion_g * overlay.a;
    let exclusion_b_premult = exclusion_b * overlay.a;
