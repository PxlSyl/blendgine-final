...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    if (overlay.a >= 0.9999) {
        ...
        textureStore(output_texture, vec2<u32>(pos), vec4<f32>(burn_r, burn_g, burn_b, overlay.a));
        return;
    }
    ...
    let burn_r_premult = burn_r * overlay.a;
    let burn_g_premult = burn_g * overlay.a;
    let burn_b_premult = burn_b * overlay.a;
