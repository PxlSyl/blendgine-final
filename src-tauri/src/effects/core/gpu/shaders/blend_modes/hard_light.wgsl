...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    if (overlay.a >= 0.9999) {
        ...
        textureStore(output_texture, vec2<u32>(pos), vec4<f32>(hard_light_r, hard_light_g, hard_light_b, overlay.a));
        return;
    }
    ...
    let hard_light_r_premult = hard_light_r * overlay.a;
    let hard_light_g_premult = hard_light_g * overlay.a;
    let hard_light_b_premult = hard_light_b * overlay.a;
