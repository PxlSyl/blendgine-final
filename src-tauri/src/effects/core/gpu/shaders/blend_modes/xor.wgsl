...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    let result_a = overlay.a + base.a - 2.0 * overlay.a * base.a;
    ...
    let xor_r_premult = xor_r * result_a;
    let xor_g_premult = xor_g * result_a;
    let xor_b_premult = xor_b * result_a;
    
    textureStore(output_texture, vec2<u32>(pos), vec4<f32>(xor_r_premult, xor_g_premult, xor_b_premult, result_a));
}