...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    if (overlay.a >= 0.9999) {
        ...
        textureStore(output_texture, vec2<u32>(pos), vec4<f32>(dodge_r, dodge_g, dodge_b, overlay.a));
        return;
    }
    ...
    let dodge_r_premult = dodge_r * overlay.a;
    let dodge_g_premult = dodge_g * overlay.a;
    let dodge_b_premult = dodge_b * overlay.a;
