...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    if (overlay.a >= 0.9999) {
        ...
        textureStore(output_texture, vec2<u32>(pos), vec4<f32>(screen_r, screen_g, screen_b, overlay.a));
        return;
    }
    ...
    let screen_r_premult = screen_r * overlay.a;
    let screen_g_premult = screen_g * overlay.a;
    let screen_b_premult = screen_b * overlay.a;
