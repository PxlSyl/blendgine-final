...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    if (overlay.a >= 0.9999) {
        ...
        textureStore(output_texture, vec2<u32>(pos), vec4<f32>(difference_r, difference_g, difference_b, overlay.a));
        return;
    }
    ...
    let difference_r_premult = difference_r * overlay.a;
    let difference_g_premult = difference_g * overlay.a;
    let difference_b_premult = difference_b * overlay.a;
