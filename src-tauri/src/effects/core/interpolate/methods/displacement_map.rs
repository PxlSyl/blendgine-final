...
impl InterpolationEngine {
    pub fn displacement_map_interpolation(
        &self,
        frame1: &DynamicImage,
        frame2: &DynamicImage,
        alpha: f32,
        ...
        self.execute_displacement_map_pipeline(&bind_group, frame1.width(), frame1.height())?;
    ...
    pub fn execute_displacement_map_pipeline(
        &self,
...

        {
            ...
            compute_pass.set_pipeline(&self.displacement_map_pipeline);
