...
impl InterpolationEngine {
    pub fn dissolve_interpolation(
        ...
        self.execute_dissolve_pipeline(&bind_group, frame1.width(), frame1.height())?;
    ...
    pub fn execute_dissolve_pipeline(
        &self,
...

        {
            ...
            compute_pass.set_pipeline(&self.dissolve_pipeline);
