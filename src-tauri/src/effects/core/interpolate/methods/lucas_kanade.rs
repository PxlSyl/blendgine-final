...
impl InterpolationEngine {
    pub fn lucas_kanade_interpolation(
        &self,
        frame1: &DynamicImage,
        frame2: &DynamicImage,
        alpha: f32,
        ...
        self.execute_lucas_kanade_interpolation_pipeline(
            &bind_group,
            frame1.width(),
            frame1.height(),
        )?;
    ...
    pub fn execute_lucas_kanade_interpolation_pipeline(
        &self,
...

        {
            ...
            compute_pass.set_pipeline(&self.lucas_kanade_pipeline);
