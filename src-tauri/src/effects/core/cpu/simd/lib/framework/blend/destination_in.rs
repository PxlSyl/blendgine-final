use crate::effects::core::cpu::simd::{
    fallback::blend::{
        ...
        destination_in::DestinationInBlend as FallbackDestinationInBlend,
    },
...
pub struct DestinationInBlend {
    fallback: FallbackDestinationInBlend,
}

impl DestinationInBlend {
    pub fn new() -> Self {
        Self {
            fallback: FallbackDestinationInBlend::new(),
        }
    }
}

impl<A: SimdArchitecture + Sync> BlendProcessor<A> for DestinationInBlend {
